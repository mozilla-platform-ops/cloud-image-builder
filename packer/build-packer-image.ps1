...
function Build-PackerImage {
  ...
  process {
     ...
     if ($null -eq $yaml_data.image.version) {
     ...
     ## Testing newer packer
     (New-Object Net.WebClient).DownloadFile(' https://roninpuppetassets.blob.core.windows.net/markcotest/packer.exe', '.\packer.exe')
