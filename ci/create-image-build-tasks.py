...
for KEY in includeKeys:
    is_packer = True if KEY in ['win10-64-2004-test', 'win10-64-2004-gpu', 'win10-64-2004', 'win10-64-2004-gpu-test', 'win10-64-2004-azure', 'win10-64-2004-azure-gpu'] else False
